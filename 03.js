...
const student = {
  ...
  const copyDeep = {};
  const deepCopy = Object.assign(copyDeep, student);
  ...
  // 깊은 복사 객체의 주소 속성을 변경하세요 (예: city를 "busan"으로 변경)
   delete deepCopy.address.city;
   deepCopy.address = {busan: "seoul"};
  // 결과 확인 
...
4. 원본 객체의 address와 깊은 복사 객체의 address가 같을까요? true
5. 원본 객체(student): { name: 'yuno', age: '30', skill: [ 'js' ], address: {} }
6. 얕은 복사된 객체(shallowCopy): { name: 'yuno', age: '30', skill: [ 'js' ], address: {} }
